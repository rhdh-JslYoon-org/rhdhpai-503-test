...
2) Go to the `Data Science Projects` section and access your application's project named `rhdhpai-503-test`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `rhdhpai-503-test-notebook`.
...
5) In the terminal, run `cd rhdhpai-503-test` to navigate to your sample app's directory.
